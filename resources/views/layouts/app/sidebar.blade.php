        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="share" :href="route('tree.index')" :current="request()->routeIs('tree.*')" wire:navigate>
                        {{ __('Family Tree') }}
                    </flux:sidebar.item>
                    ...
                    <flux:sidebar.item icon="book-open" :href="route('stories.index')" :current="request()->routeIs('stories.*')" wire:navigate>
                        {{ __('Stories') }}
                    </flux:sidebar.item>
